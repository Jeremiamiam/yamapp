...
- [x] **Phase 9: Retroplanning IA** - Génération automatique de retroplanning par l'IA à partir du brief client, vue Gantt dans la fiche client (completed 2026-02-22)
...
- [x] 12-02-PLAN.md -- ClientDetailV2 layout + ClientSidebarSection + ProjectsListSection + footer retro ✅
...
*2026-02-22: Phase 12 Plan 02 complété -- ClientDetailV2 layout (sidebar fixe + zone projets + footer retroplanning), ClientSidebarSection (contacts/liens/docs client filtrés), ProjectsListSection (cards projet + badge facturation), ClientDetail délègue à V2*
